		...
		<div class="bt-post">		
			<div class="bt-post--thumbnail">
				...
				<div class="bt-post--categories"> 
					<?php the_terms( $post_item['ID'], 'category', '<div class="bt-post-cat">', ', ', '</div>' ); ?>
				</div>
			</div>
			...
			<div class="bt-post--infor">
				...
				<div class="bt-post-author-w-avatar"> 
					...
					<h4 class="bt-post-author-w-avatar--name"> 
						<span><?php echo esc_html__('By ', 'autoart') ?> </span> <?php the_author(); ?> 
					</h4>
				</div>
			</div>
		</div>

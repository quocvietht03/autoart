<?php
/**
 * Block Name: Widget - Subscribe Contact
**/
...
?>
<div id="<?php echo 'bt_block--' . $block['id']; ?>" class="widget widget-block bt-block-subscribe-contact">
  <div class="bt-subscribe-contact">
    <div class="bt-subscribe-contact-header"> 
      ...
      <div class="bt-subscribe-contact-header-inner">
        <?php 
          if(!empty($heading)) {
            echo '<h3 class="bt-subscribe-contact--heading">' . $heading . '</h3>';
          }
          
          if(!empty($desc)) {
            echo '<div class="bt-subscribe-contact--desc">' . $desc . '</div>';
          }
        ?>
      </div>
    </div>

    <div class="bt-subscribe-contact--form">  
      <?php 
          if(!empty($form)) {

...
add_action('comment_form_before_fields', 'autoart_comment_rating_rating_field');
...
add_action('comment_post', 'autoart_comment_rating_save_comment_rating');
function autoart_comment_rating_save_comment_rating($comment_id)
{
...
add_action('autoart_comment_rating_display', 'autoart_comment_rating_display', 50);
function autoart_comment_rating_display()
{
	if ($rating = get_comment_meta(get_comment_ID(), 'rating', true)) {
		echo '<div class="bt-comment-stars">';

		for ($i = 1; $i <= 5; $i++) {
			if ($i <= $rating) {
				echo '<span class="bt-filled"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
										<path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/>
									</svg></span>';
			} else {
				echo '<span><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
										<path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/>
									</svg></span>';
			}
		}
...
function autoart_comment_rating_get_average_ratings($id)
{
...
function autoart_comment_rating_render_html($id)
{
	$cm_number = get_comments_number($id);
	$avg_rating = autoart_comment_rating_get_average_ratings($id);

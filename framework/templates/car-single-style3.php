    ...
    <div class="bt-post--sidebar">
      <div class="bt-sidebar-wrap">
        <div class="bt-sidebar-block bt-sale-block">
          ...
          <div class="bt-sale-meta">
            <div class="bt-sale-meta-col">
              <div class="bt-sale-meta-item bt-sale-date">
            ...
            <div class="bt-sale-meta-col">
              <div class="bt-sale-meta-item bt-sale-mileage">
                <div class="bt-meta-item">
            ...
            <div class="bt-sale-meta-col">
              <div class="bt-sale-meta-item bt-sale-fuel-type">
                <div class="bt-meta-item">
                  <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bt-sale-meta-col">
              <div class="bt-sale-meta-item bt-sale-transmission">
                <div class="bt-meta-item">
                  <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="bt-sidebar-block bt-dealer-block">
          <?php
          if (!empty($dealer)) {
  ...
  <div class="bt-post--tabs bt-tabs bt-tabs-js">
    <div class="bt-tabs--tbnav">
      <a href="#bt_panel_overview" class="bt-nav-item bt-is-active">
        <span><?php echo esc_html__('Car Overview', 'autoart'); ?></span>
      </a>
      ...
      <?php if (!empty($features)) { ?>
        <a href="#bt_panel_features" class="bt-nav-item">
          <span><?php echo esc_html__('Car Features', 'autoart'); ?></span>
        </a>
      <?php } ?>
      <?php if (!empty($location) || !empty($map_iframe)) { ?>
        <a href="#bt_panel_location" class="bt-nav-item">
          <span><?php echo esc_html__('Location', 'autoart'); ?></span>
        </a>
      <?php } ?>
      <?php if (comments_open() || get_comments_number()) { ?>
        <a href="#bt_panel_review" class="bt-nav-item">
          <span><?php echo esc_html__('review', 'autoart'); ?></span>
        </a>
      <?php } ?>
      <?php
      ...
      ?>
        <a href="#bt_panel_safety" class="bt-nav-item">
          <span> <?php echo esc_html__('Safty Tips', 'autoart'); ?></span>
        </a>
      <?php } ?>
    </div>
    <div class="bt-tabs--tbpanel">
      ...
      <?php if (!empty($features)) { ?>
        <div id="bt_panel_features" class="bt-panel-item bt-panel-features">
          <div class="bt-panel-item--inner">
            <h3 class="bt-title-ss">
      ...
      <?php } ?>
      <?php if (!empty($location) || !empty($map_iframe)) { ?>
        <div id="bt_panel_location" class="bt-panel-item bt-panel-location">
          <div class="bt-panel-item--inner">
            <h3 class="bt-title-ss">
      ...
      <?php if (comments_open() || get_comments_number()) { ?>
        <div id="bt_panel_review" class="bt-panel-item bt-panel-review">
          <div class="bt-panel-item--inner">
            <h3 class="bt-title-ss">
              <?php echo '<span>' . esc_html__('Add A Review', 'autoart') . '</span>'; ?>
            </h3>
            <?php
            comments_template();
            ?>
      ...
      if (!empty($safety_tips) && (!empty($safety_tips['heading']) || !empty($safety_tips['content']) || !empty($safety_tips['link']))) {
      ?>
        <div id="bt_panel_safety" class="bt-panel-item bt-panel-safety">
          <div class="bt-panel-item--inner">

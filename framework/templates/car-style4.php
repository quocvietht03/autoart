...
$images_transparent = get_field('images_transparent');
...
<article <?php post_class('bt-post'); ?>>
  <div class="bt-post--inner">
    <div class="bt-post--thumbnail">
      <div class="bt-post--featured ">
        <a href="<?php the_permalink(); ?>">
          <div class="bt-cover-image bt-effect-move-horizontal">
            <?php
            if ($images_transparent) {
              echo wp_get_attachment_image($images_transparent['ID'], $args['image-size']);
            }
            ?>
          </div>
        </a>
    ...
    <div class="bt-post--infor">
      ...
      <?php } ?>
      <?php if (!empty($color_term)) { ?>
        <div class="bt-post--color">
          <?php
          echo '<span class="bt-label" >' . esc_html__('Color Veriations', 'autoart') . '</span>';
          foreach ($color_term as $color) {
            echo '<span class="bt-value" style="background:' . $color->slug . '"></span>';
          }

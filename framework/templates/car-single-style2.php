...
<article <?php post_class('bt-post'); ?>>
  <div class="bt-post--main">
    <div class="bt-post--infor">
      ...
      <div class="bt-post--sale-car">
        <div class="bt-sale-car">
          <?php the_terms(get_the_ID(), 'car_body', '<div class="bt-sale-body">', ', ', '</div>'); ?>
          ...
          <div class="bt-sale-offer">
            <a class="bt-offer-btn" href="#">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M20.0638 10.214C20.0638 10.566 19.7398 11.082 19.3958 11.426L12.5478 18.252L3.75516 9.46468L10.5925 2.64933C10.9058 2.336 11.4065 1.93534 11.7598 1.93534H19.4252C19.7778 1.93534 20.0638 2.22065 20.0638 2.57198V10.214ZM10.5925 20.2027C10.0518 20.7407 9.17582 20.7407 8.63582 20.2027L1.78849 13.3753C1.24782 12.8373 1.24782 11.964 1.78849 11.426L2.77648 10.44L11.5598 19.2373L10.5925 20.2027ZM20.0638 0.661987H11.1212C10.4152 0.661987 10.2865 0.969991 9.61382 1.67399L0.8105 10.4507C-0.270167 11.5274 -0.270167 13.274 0.8105 14.3507L7.65716 21.178C8.73783 22.2547 10.4892 22.2547 11.5698 21.178L20.3745 12.4013C20.9405 11.836 21.3418 11.5547 21.3418 10.8507V1.93534C21.3418 1.23268 20.7691 0.661987 20.0638 0.661987ZM15.9718 8.01265C15.4312 8.55065 14.5558 8.55065 14.0152 8.01265C13.4752 7.47399 13.4752 6.60068 14.0152 6.06201C14.5558 5.52334 15.4312 5.52334 15.9718 6.06201C16.5125 6.60068 16.5125 7.47399 15.9718 8.01265ZM13.0378 5.08667C11.9572 6.164 11.9572 7.91001 13.0378 8.98735C14.1178 10.0647 15.8698 10.0647 16.9505 8.98735C18.0305 7.91001 18.0305 6.164 16.9505 5.08667C15.8698 4.01 14.1178 4.01 13.0378 5.08667Z" />
              </svg>
              <?php echo '<span>' . esc_html__('Make An Offer Price', 'autoart') . '</span>'; ?>
            </a>
          </div>
        </div>
      </div>
    ...
    <?php if (!empty($gallery)) { ?>
      <div class="bt-post--gallery">
        <?php if (has_post_thumbnail()) { ?>
          <div class="bt-img-thumbnail">
            <a href="<?php echo get_the_post_thumbnail_url()  ?>" class="elementor-clickable bt-image-item" data-elementor-lightbox-slideshow="bt-gallery-car">
        ...
        <?php } ?>
        <div class="bt-list-image-item  <?php if (!has_post_thumbnail()) { ?> no-thumb <?php } ?>">
          <?php foreach ($gallery as $key => $item) {
            if ($key < 4) {
          ?>
              <a href="<?php echo esc_url($item['url'])  ?>" class="elementor-clickable bt-image-item" data-elementor-lightbox-slideshow="bt-gallery-car">
                <div class="bt-cover-image">
        ...
        <?php
        $quantity_gallery = count($gallery);
        if ($quantity_gallery > 4) {
        ?>
          <div class="bt-list-image-item-full">
            <?php foreach ($gallery as $key => $item) {
              if ($key >= 4) {
            ?>
                <a href="<?php echo esc_url($item['url'])  ?>" class="elementor-clickable bt-image-item" data-elementor-lightbox-slideshow="bt-gallery-car">
    ...
    <div class="bt-post--section bt-section-overview">
      <h3 class="bt-title-ss">
        <?php echo '<span>' . esc_html__('Car Overview:', 'autoart') . '</span>'; ?>
      </h3>
      ...
      <div class="bt-content-ss bt-meta-list">
        ...
        <div class="bt-meta-item bt-engine">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
            <path d="M15.1667 8.66663V5.41663M11.9167 5.41663H18.4167M6.5 13H3.25M3.25 9.74996V16.25M22.75 11.9166V20.5833M9.75 13H9.76083M13 13H13.0108M16.25 13H16.2608M6.5 8.66663V17.3333H8.66667L10.8333 20.5833H19.5V10.8333L17.3333 8.66663H6.5Z" stroke="#1FBECD" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
    ...
    <?php if (!empty(get_the_content())) { ?>
      <div class="bt-post--section bt-section-description">
        <h3 class="bt-title-ss">
    ...
    <div class="bt-post--wrap">
      <div class="bt-post--inner">
        <?php if (!empty($features)) { ?>
          <div class="bt-post--section bt-section-features">
            <h3 class="bt-title-ss">
              <?php echo '<span>' . esc_html__('Car Features:', 'autoart') . '</span>'; ?>
            </h3>

            <div class="bt-content-ss bt-feature-list">
        ...
        <?php if (!empty($location) || !empty($map_iframe)) { ?>
          <div class="bt-post--section bt-section-location">
            <h3 class="bt-title-ss">
              <?php echo '<span>' . esc_html__('Location:', 'autoart') . '</span>'; ?>
            </h3>

            <div class="bt-content-ss">
              <?php if (!empty($location)) { ?>
                <div class="bt-location-title">
                  ...
                  <?php if (!empty($map_link)) { ?>
                    <a class="bt-location-link" href="<?php echo esc_url($map_link); ?>" target="_blank">
                      <?php echo esc_html__('Get Direction', 'autoart'); ?>
                    </a>
                  <?php } ?>
                </div>
              <?php } ?>
        ...
        <div class="bt-post--section bt-section-review">
          <?php
      ...
      <div class="bt-post--sidebar">
        <div class="bt-sidebar-wrap">
          <div class="bt-sidebar-block bt-sale-dealer-block">
            <?php
            if (!empty($dealer)) {
            ...
            ?>
              <div class="bt-sale-dealer">
                <div class="bt-dealer-title">
                  <?php echo esc_html__('Seller Details:', 'autoart'); ?>
                </div>
                ...
                <div class="bt-dealer-action">
                  <?php if (!empty($d_message_link)) { ?>
                    <a class="bt-message-btn" href="<?php echo esc_url($d_message_link); ?>" target="_blank">
                      <?php echo esc_html__('Message Seller', 'autoart'); ?>
                    </a>
                  <?php } ?>

                  <?php if (!empty($d_whatsapp_link)) { ?>
                    <a class="bt-whatsapp-btn" href="<?php echo esc_url($d_whatsapp_link); ?>" target="_blank">
                      <?php echo esc_html__('Chat Via Whatsapp', 'autoart'); ?>
                    </a>
                  <?php } ?>
          ...
          ?>
            <div class="bt-sidebar-block bt-safety-block">
              ...
              if (!empty($safety_tips['content'])) {
                echo '<div class="bt-safety-content bt-fl-no-mg">' . $safety_tips['content'] . '</div>';
              }
              ?>

...
namespace AutoArtElementorWidgets\Widgets\MobileMenu;
...
class Widget_MobileMenu extends Widget_Base
{
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				...
				[
					...
					'description' => sprintf(
						...
						esc_html__( 'Go to the %1$sMenus screen%2$s to manage your menus.', 'autoart' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'autoart' ),
					'content' => sprintf(
						/* translators: 1: Link opening tag, 2: Link closing tag. */
						esc_html__( 'Go to the %1$sMenus screen%2$s to create one.', 'autoart' ),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Main Menu', 'autoart'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Color', 'autoart' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Active', 'autoart' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Padding', 'autoart' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Toggle Offset', 'autoart' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Sub Menu', 'autoart'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional Options', 'autoart'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'heading_toggle_menu',
			[
				'label' => esc_html__( 'Toggle Menu', 'autoart' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Divider Menu', 'autoart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'divider_menu_style',
			[
				'label' => esc_html__( 'Style', 'autoart' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => esc_html__( 'None', 'autoart' ),
					'solid' => esc_html__( 'Solid', 'autoart' ),
					'double' => esc_html__( 'Double', 'autoart' ),
					'dotted' => esc_html__( 'Dotted', 'autoart' ),
					'dashed' => esc_html__( 'Dashed', 'autoart' ),
				],
				'default' => 'solid',
				'selectors' => [

<?php
namespace AutoArtElementorWidgets\Widgets\SiteSocialStyle2;
...
class Widget_SiteSocialStyle2 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Social Style 2', 'autoart' );
	}
	...
	protected function register_style_content_section_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				Group_Control_Typography::get_type(),[
					...
					'label' => __( 'Title Typography', 'autoart' ),
					'default' => '',
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'icon_color',[
					'label'     => esc_html__( 'Color Normal', 'autoart' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [

	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-car-layout' => 'gap:{{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		<div class="bt-elwg-cars-grid-list--default">
			<div class="bt-cars-grid-list-template">
				...
				<div class="bt-filter-results">
					...
					if ($wp_query->have_posts()) {
					?>
						<div class="bt-car-layout" data-view="<?php echo isset($_GET['view_type']) && $_GET['view_type'] != '' ? $_GET['view_type'] : $settings['layout'] ?>" data-limit="<?php echo esc_attr($settings['posts_per_page']); ?>">
							<?php
							while ($wp_query->have_posts()) {
								$wp_query->the_post();

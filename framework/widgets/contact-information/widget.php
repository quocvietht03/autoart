<?php
namespace AutoArtElementorWidgets\Widgets\ContactInformation;
...
class Widget_ContactInformation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Infomation', 'autoart' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'description',
			[
				'label' => esc_html__( 'Description', 'autoart' ),
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__( 'Button Text', 'autoart' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
			]
		...
		$this->add_control(
			'button_url',
			[
				'label' => esc_html__( 'Button Url', 'autoart' ),
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'autoart' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Description Typography', 'autoart' ),
				'default' => '',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Typography', 'autoart' ),
				'default' => '',

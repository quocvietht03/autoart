<?php
namespace AutoArtElementorWidgets\Widgets\TestimonialSlider;
...
class Widget_TestimonialSlider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Testimonial Slider', 'autoart' );
	}
  ...
  public function get_icon() {
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			'info_style',
			[
				'label' => __( 'Info Background', 'autoart' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'info_bg_color_hover',
			[
				'label' => __( 'Background Color Hover', 'autoart' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Arrows', 'autoart' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);

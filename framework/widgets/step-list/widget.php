<?php
namespace AutoArtElementorWidgets\Widgets\StepList;
...
class Widget_StepList extends Widget_Base {
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'list',
			[
				'label' => __( 'List Step', 'autoart' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'autoart' ),
						'step_title' => __( 'This is step title 01', 'autoart' ),
						'step_desc' => __( 'This is description', 'autoart' ),
						'step_btn_text' => __( 'Read More', 'autoart' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'autoart' ),
						'step_title' => __( 'This is step title 02', 'autoart' ),
						'step_desc' => __( 'This is description', 'autoart' ),
						'step_btn_text' => __( 'Read More', 'autoart' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'autoart' ),
						'step_title' => __( 'This is step title 03', 'autoart' ),
						'step_desc' => __( 'This is description', 'autoart' ),
						'step_btn_text' => __( 'Read More', 'autoart' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'autoart' ),
						'step_title' => __( 'This is step title 04', 'autoart' ),
						'step_desc' => __( 'This is description', 'autoart' ),
						'step_btn_text' => __( 'Read More', 'autoart' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'autoart' ),
						'step_title' => __( 'This is step title 05', 'autoart' ),
						'step_desc' => __( 'This is description', 'autoart' ),
						'step_btn_text' => __( 'Read More', 'autoart' ),
						'step_btn_link' => '#'
					],

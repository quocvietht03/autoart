<?php
function autoart_register_layout_category($categories)
{
...
add_filter('block_categories_all', 'autoart_register_layout_category');

function autoart_acf_init()
{
    ...
    if (function_exists('acf_register_block')) {
        acf_register_block(array(
            ...
            'title'             => __('Widget - Recent Posts', 'autoart'),
            'description'       => __('Widget - Recent Posts block.', 'autoart'),
            'render_callback'   => 'autoart_acf_block_render_callback',
            // 'enqueue_assets' => 'autoart_acf_block_assets_callback',
        ...
        acf_register_block(array(
            'name'              => 'widget-subscribe-contact',
            'title'             => __('Widget - Subscribe Contact', 'autoart'),
            'description'       => __('Widget - Subscribe Contact block.', 'autoart'),
            'render_callback'   => 'autoart_acf_block_render_callback',
            // 'enqueue_assets' => 'autoart_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
            'keywords'          => array('Subscribe Contact', 'Subscribe', 'Contact'),
        ));

        acf_register_block(array(
            'name'              => 'widget-instagram-posts',
            'title'             => __('Widget - Instagram Posts', 'autoart'),
            'description'       => __('Widget - Instagram Posts block.', 'autoart'),
            'render_callback'   => 'autoart_acf_block_render_callback',
            // 'enqueue_assets' => 'autoart_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
...
add_action('acf/init', 'autoart_acf_init');

function autoart_acf_block_render_callback($block)
{
...
function autoart_acf_block_assets_callback($block)
{
